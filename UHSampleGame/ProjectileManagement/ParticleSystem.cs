...
namespace UHSampleGame.ProjectileManagment
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (firstActiveParticle != firstFreeParticle)
            {
                ScreenManager.GraphicsDeviceManager.GraphicsDevice.BlendState = settings.BlendState;
                ScreenManager.GraphicsDeviceManager.GraphicsDevice.DepthStencilState = DepthStencilState.DepthRead;
                ...
                ScreenManager.GraphicsDeviceManager.GraphicsDevice.SetVertexBuffer(vertexBuffer);
